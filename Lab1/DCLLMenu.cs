...
namespace Lab1
{
    public class DCLLMenu
    {
        ...
        private static Dictionary<string, DoubleCircularLinkedList<float>>? Lists = new();
        ...
        private static void CreateList()
        {
            ...
            Lists?.Add(listName, new DoubleCircularLinkedList<float>());
        }
        ...
        private static void MergeLists()
        {
            ...
            DoubleCircularLinkedList<float> temp1 = new();
            DoubleCircularLinkedList<float> temp2 = new();
            if (Lists != null)
            ...
            DoubleCircularLinkedList<float> mergedList = temp1.Merge(temp2);
